...
$db=new mysqli("localhost","wthhh","2019@qqa","travel");
if ($db->connect_error) {
...
<body>
    ...
    <main class="container">
          ...
          <div class="panel-body">
            <form action="Lab11.php" method="get" class="form-horizontal">
              ...
              <select name="country" class="form-control">
                ...
                $resultCountries=$db->query("SELECT CountryName ,ISO FROM countries") ;
		...
		<ul class="caption-style-2">
            <?php 
              // echo "SELECT * FROM imagedetails WHERE CountryCodeISO='" . $_GET['country'] . "', ContinentCode='" . $_GET['continent'] . "'";
              $image=$db->query("SELECT * FROM imagedetails");
